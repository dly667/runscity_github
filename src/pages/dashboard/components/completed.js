...
function Completed ({ data }) {
  return (
    <div className={styles.sales}>
      <div className={styles.title}>每日用户增长</div>
      <ResponsiveContainer minHeight={360}>
        <AreaChart data={data}>
          ...
          />
          <Area type="monotone" dataKey="Daily growth" stroke={color.grass} fill={color.grass} strokeWidth={2} dot={{ fill: '#fff' }} activeDot={{ r: 5, fill: '#fff', stroke: color.green }} />
